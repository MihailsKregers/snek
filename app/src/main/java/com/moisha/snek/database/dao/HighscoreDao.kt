...
interface HighscoreDao {
    ...
    @Query("SELECT players.name AS uName, highscores.score AS score FROM highscores INNER JOIN players ON highscores.uId = players.id WHERE speed = :speed AND levelID = :levelId")
